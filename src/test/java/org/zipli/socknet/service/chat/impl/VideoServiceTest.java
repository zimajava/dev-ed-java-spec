...
public class VideoServiceTest {
    ...
    private final Chat chat = new Chat(videoData.getChatName(), false, videoData.getUserId());
    private final ChatData userData = new ChatData(videoData.getUserId(), videoData.getChatId());
